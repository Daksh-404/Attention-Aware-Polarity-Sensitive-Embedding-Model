...
if __name__=='__main__':
    ...
    triplet_train_dataset = TripletDataset("Fi/fi_trainimg_label.txt","train",transform) # Returns triplets of images
    triplet_valid_dataset = TripletDataset("Fi/fi_valimg_label.txt","valid",transform)
    triplet_test_dataset = TripletDataset("Fi/fi_testimg_label.txt","test",transform)
    batch_size = 64
    ...
    fit(triplet_train_loader, triplet_valid_loader, model, loss_fn1,loss_fn2, optimizer, scheduler, n_epochs, log_interval)
